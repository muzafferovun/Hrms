...
public class PersonEducationGetDto {
	private int id;
	...
	public PersonEducationGetDto() {
		super();
	}
	public PersonEducationGetDto(int id, int personId, String educationInfo, LocalDate educationStartDate,
